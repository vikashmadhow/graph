 ...
 */
public class ConnectedComponents<V, W, R> implements Algorithm<V, W, R> {
   ...
   */
  public ConnectedComponents(V startVertex) {
   ...
   */
  public ConnectedComponents<V, W, R> pathQueue(PathQueue<V, W> pathQueue) {
   ...
   */
  public ConnectedComponents<V, W, R> exploreOp(ExploreOp<V, W, R> exploreOp) {
   ...
   */
  public ConnectedComponents<V, W, R> expandOp(ExpandOp<V, W> expandOp) {
   ...
   * a goal vertex.
   */
  public ConnectedComponents<V, W, R> pathCostOp(PathCostOp<V, W> pathCostOp) {
