 ...
 */
public class DepthFirstExplore<V, W, R> implements Algorithm<V, W, R> {
   ...
   */
  public DepthFirstExplore<V, W, R> exploreOp(ExploreOp<V, W, R> exploreOp) {
   ...
   */
  public DepthFirstExplore<V, W, R> expandOp(ExpandOp<V, W> expandOp) {
   ...
   * a goal vertex.
   */
  public DepthFirstExplore<V, W, R> pathCostOp(PathCostOp<V, W> pathCostOp) {
